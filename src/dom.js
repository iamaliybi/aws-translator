...
const linkToSocialMedia = () => {
	const SOCIAL_MEDIA = [
		{
			name: 'Github',
			path: 'https://github.com/iamaliybi',
			target: '_blank',
		...
		{
			name: 'Stackoverflow',
			path: 'https://stackoverflow.com/users/11662335/ali-yaghoubi',
			target: '_blank',
		...
		{
			name: 'Mail',
			path: 'mailto:iamaliybi.dev@gmail.com',
			target: '_self',
		...
		{
			name: 'Instagram',
			path: 'https://www.instagram.com/iamaliybi/',
			target: '_blank',
