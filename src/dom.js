...
const linkToSocialMedia = () => {
	const SOCIAL_MEDIA = [
		...
		{
			name: 'Instagram',
			path: 'https://www.instagram.com/_.edwardjoseph/',
			target: '_blank',
	...
	const socialDiv = createEl('div', {
		class: 'social-media'
	});

	// Add social-media links
	SOCIAL_MEDIA.forEach(m => {
